...
namespace TimeSheet.Commands {
    public class FinishWorkJourneyCommandHandler : ICommandHandler<FinishWorkJourneyCommand, FinishWorkJourneyCommandResult> {
        ...
        public FinishWorkJourneyCommandHandler(WorkJourneyInProgressRepository repository, UserRepository userRepository, WorkJourneyRepository workJourneyRepository, WorkJourneyBuilder workJourneyBuilder) {
