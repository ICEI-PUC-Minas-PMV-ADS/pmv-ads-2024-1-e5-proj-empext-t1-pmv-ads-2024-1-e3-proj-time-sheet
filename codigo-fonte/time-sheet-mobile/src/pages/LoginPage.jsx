      ...
      <View className="flex-1 w-full flex-col justify-end items-center mt-20">
        <AdjustableModal>
          <View className="flex h-full w-full">
            <Text className="text-3xl font-bold text-primary-800 mb-1">Bem vindo!</Text>
            <Text className="text-sm font-semibold mb-5">Trabalhe com mais controle e segurança.</Text>
            <Input className="mb-5" label="CPF" placeholder="000.000.000-00" keyboardType="numeric" mask="999.999.999-99" setInputValue={handleCpfInput} />
            <Input className="mb-2" label="Senha de acesso" placeholder="digitar" secure="true" setInputValue={handlePasswordInput} />
            <ErrorMessage show={errorVisible} message={error} />
            <TouchableOpacity className="flex flex-row self-end mb-5" onPress={() => { navigation.navigate("ChangePassword") }}>
